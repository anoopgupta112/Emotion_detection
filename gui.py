...
def Detect(file_path):
    ...
    try:
        ...
        if number_of_edges > 100:
            ...
            label2.configure(foreground="#011638", text="Wrinkle Found")

        else:
            print(number_of_edges)

            label2.configure(foreground="#011638", text="No Wrinkle Found")

            # wrikle code ends here
...
# part 2 
# function which will show text after the indification
